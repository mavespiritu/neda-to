...
<div>
    <div class="pull-left">
        ...
        <?= Html::a('<i class="fa fa-folder-o"></i> Manage Items', ['/v1/ppmp/view', 'id' => $model->id], ['class' => 'btn btn-app']) ?>
        <?= Html::a('<i class="fa fa-search"></i> Search Item', ['/v1/ppmp/item-check', 'id' => $model->id], ['class' => 'btn btn-app']) ?>
