...
<a href="javascript:void(0);" onclick="printAoq(<?= $model->id ?>,<?= $rfq->id ?>);" class="btn btn-info btn-sm"><i class="fa fa-print"></i> Print</a>
</span>
<br>
<br>
...
<?php
    $script = '
        function printAoq(id, $rfq_id)
        {
            var printWindow = window.open(
                "'.Url::to(['/v1/pr/print-aoq']).'?id=" + id + "&rfq_id=" + '.$rfq->id.', 
                "Print",
                "left=200", 
                "top=200", 
                "width=650", 
