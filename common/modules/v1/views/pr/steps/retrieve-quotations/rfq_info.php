...
<div class="rfq-info-content">
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <td><span style="display: inline-block; border-bottom: 1px solid black; width: 400px;"><?= $supplier->business_name ?></span></td>
        </tr>
        <tr>
            <td>Complete Address:</td>
            <td><span style="display: inline-block; border-bottom: 1px solid black; width: 400px;"><?= $supplier->business_address ?></span></td>
        </tr>
        <tr>
            <td>&nbsp;</td>
        ...
        <tr>
            <td>Telephone No.:</td>
            <td><span style="display: inline-block; border-bottom: 1px solid black; width: 400px;"><?= $supplier->landline ?></span></td>
        </tr>
        <tr>
            <td>Cellphone No.:</td>
            <td><span style="display: inline-block; border-bottom: 1px solid black; width: 400px;"><?= $supplier->mobile_no ?></span></td>
        </tr>
        <tr>
            <td>PhilGeps Reg. No.:</td>
            <td><span style="display: inline-block; border-bottom: 1px solid black; width: 400px;"><?= $supplier->philgeps_no ?></span></td>
        </tr>
        <tr>
            <td>TIN:</td>
            <td><span style="display: inline-block; border-bottom: 1px solid black; width: 400px;"><?= $supplier->tin_no ?></span></td>
        </tr>
    </table>
    <br>
                ...
                <?php if(!empty($items)){ ?>
                    <?php foreach($items as $item){ ?>
                        <tr>
                            ...
                            <td align=right>P<span style="display: inline-block; border-bottom: 1px solid black; width: 60%;"><?= number_format($item['offer'], 2) ?></span></td>
                            <td align=right>P<span style="display: inline-block; border-bottom: 1px solid black; width: 60%;"><?= number_format($item['total'] * $item['offer'], 2) ?></span></td>
                        </tr>
                        <?php $i++; ?>
