    ...
    <div class="row" style="margin-left: 50px;">
        ...
        <div class="col-md-11">
            <ol type="1">
                ...
                <?= $rfq->supply_equipment ?> <?= $rfq->supply_equipment != '' ? $rfq->supply_equipment > 1 ? '<u><b>'.$rfq->supply_equipment.' '.$rfq->supply_equipment_unit.'</b></u>' : '<u><b>'.$rfq->supply_equipment.' '.substr_replace($rfq->supply_equipment_unit, "", -1).'</b></u>' : '<span style="display: inline-block; border-bottom: 1px solid black; width: 40px;"></span>' ?> FOR EQUIPMENT, FROM DATE OF ACCEPTANCE BY THE PROCURING ENTITY.
                </li>
