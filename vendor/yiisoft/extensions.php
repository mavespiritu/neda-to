...
return array (
  ...
  array (
    'name' => 'axelpal/yii2-attachments',
    'version' => '9999999-dev',
    'alias' => 
    array (
      '@file' => $vendorDir . '/axelpal/yii2-attachments',
    ),
  ),
  ...
  'markavespiritu/yii2-user' => 
  array (
    'name' => 'markavespiritu/yii2-user',
    'version' => '0.9.14.0',
    'alias' => 
    array (
      '@markavespiritu/user' => $vendorDir . '/markavespiritu/yii2-user',
    ),
    'bootstrap' => 'markavespiritu\\user\\Bootstrap',
  ),
  'markavespiritu/yii2-rbac' => 
  array (
    'name' => 'markavespiritu/yii2-rbac',
    'version' => '1.0.0.0-alpha',
    'alias' => 
    array (
      '@markavespiritu/rbac' => $vendorDir . '/markavespiritu/yii2-rbac',
    ),
    'bootstrap' => 'markavespiritu\\rbac\\Bootstrap',
  ),
